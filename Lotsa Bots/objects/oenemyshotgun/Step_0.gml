...
//Horizontal Movement
if ( instance_exists( target ) && point_distance(x, 0, target.x, 0) >= 250 ) hDir = sign(target.x - x); else hDir = 0;
...
//Vertical Movement
if ( instance_exists( target ) && point_distance(0, y, 0, target.y) >= 250 ) vDir = sign(target.y - y); else vDir = 0;
