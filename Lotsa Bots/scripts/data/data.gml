function WeaponData()
{
	...
	weapon[weapons.unarmed] = [ 20, 1, 10, 132, 0,  15, false, 0, 0,  -1,		sBatHitbox, 1, 1, 0, c_white, 1 ];
...
{
	weapon[weapons.none]	= [ 0,  0, 0,  0,  0,  0, true,  0, 0,  sMissing,	  sMissing,		1, 1, 0, c_white, 1 ];
	weapon[weapons.unarmed] = [ 80, 1, 10, 50, 0,  4, false, 0, 0,	-1,			  sBatHitbox,   1, 1, 0, c_white, 1 ];
	weapon[weapons.smg]		= [ 36, 1, 30, 0,  15, 2, true,  0, 5,  sBulletEnemy, sBulletEnemy, 1, 1, 0, c_white, 1 ];
